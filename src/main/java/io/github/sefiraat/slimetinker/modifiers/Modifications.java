...
public class Modifications {
    ...
    @Getter
    protected static final Map<Integer, Integer> MOD_MAP_PLATE_TOOL = new HashMap<>();
    ...
    static {
        ...
        MOD_MAP_PLATE_TOOL.put(1, 1);
        MOD_MAP_PLATE_TOOL.put(2, 1);
        MOD_MAP_PLATE_TOOL.put(3, 1);
        MOD_MAP_PLATE_TOOL.put(4, 1);
        MOD_MAP_PLATE_TOOL.put(5, 1);
        MOD_MAP_PLATE_TOOL.put(6, 1);
        MOD_MAP_PLATE_TOOL.put(7, 1);
        MOD_MAP_PLATE_TOOL.put(8, 1);
        MOD_MAP_PLATE_TOOL.put(9, 1);
        MOD_MAP_PLATE_TOOL.put(10, 1);
        MODIFICATION_DEFINITIONS_TOOL.put(StackUtils.getIDorType(Materials.MOD_PLATE), new Mod(MOD_MAP_PLATE_TOOL, SlimeTinker.inst().getKeys().getStModLevelObsidian()));
