...
public class ShovelHead extends UnplaceableBlock {
    ...
    public static List<String> getLore(String material) {
        ...
        list.add("");
        list.add(ThemeUtils.PASSIVE + "A shovel head. Useless by itself, can be");
        list.add(ThemeUtils.PASSIVE + "made into a shovel at the Tinker's table.");
        list.add("");
    ...
    public ShovelHead(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
