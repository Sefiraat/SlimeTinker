...
public class SwordBlade extends UnplaceableBlock {
    ...
    public static String getName(String material) {
        return
                ...
                ThemeUtils.ITEM_PART + " Sword Blade";
    }

    public static List<String> getLore(String material) {
        List<String> list = new ArrayList<>();
        list.add("");
        list.add(ThemeUtils.PASSIVE + "A sword blade. Useless by itself, can be");
        list.add(ThemeUtils.PASSIVE + "made into a sword at the Tinker's table.");
        list.add("");
    ...
    public SwordBlade(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
