...
public class HoeHead extends UnplaceableBlock {
    ...
    public static String getName(String material) {
        return
                ...
                ThemeUtils.ITEM_PART + " Hoe Head";
    }

    public static List<String> getLore(String material) {
        List<String> list = new ArrayList<>();
        list.add("");
        list.add(ThemeUtils.PASSIVE + "A hoe head. Useless by itself, can be");
        list.add(ThemeUtils.PASSIVE + "made into a hoe at the Tinker's table.");
        list.add("");
    ...
    public HoeHead(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
